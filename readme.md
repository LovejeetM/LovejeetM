...
<table style="margin-bottom: 50px; width: 100%; table-layout: fixed;">
  <tr>
    <td width="50%" style="vertical-align: top; padding: 10px; background-color: #0a0a2a; border-radius: 12px; color: #e0e0e0; border: 1px solid rgba(50, 150, 255, 0.2);">
      <h5>            </h5>
      <img 
        src="./img/serena.png" 
      ...
      >
      <h3 style="color: #00bfff;">Serena: AI Therapy Platform</h3>
      ...
      <a href="https://github.com/LovejeetM/Serena" target="_blank" style="color: #00bfff; text-decoration: none;">View Project →</a>
      <h5>            </h5>
    </td>
    <td width="50%" style="vertical-align: top; padding: 10px; background-color: #0a0a2a; border-radius: 12px; color: #e0e0e0; border: 1px solid rgba(50, 150, 255, 0.2);">
      <h5>            </h5>
      <img 
        ...
        style="border-radius: 8px; margin-bottom: 10px;"
      >
      <h3 style="color: #00bfff;">Weather Point: Java Desktop App</h3>
      ...
      <a href="https://github.com/LovejeetM/Weather-Point" target="_blank" style="color: #00bfff; text-decoration: none;">View Project →</a>
      <h5>            </h5>
    </td>
  </tr>
  <tr>
    <td width="50%" style="vertical-align: top; padding: 10px; background-color: #0a0a2a; border-radius: 12px; color: #e0e0e0; border: 1px solid rgba(50, 150, 255, 0.2);">
      ...
      <img 
        ...
        style="border-radius: 8px; margin-bottom: 10px;"
      >
      <h3 style="color: #00bfff;">Chess ML & Move Prediction</h3>
      ...
      <a href="https://github.com/LovejeetM/Chess_ML_Algorithm" target="_blank" style="color: #00bfff; text-decoration: none;">View Project →</a>
      <h5>            </h5>
    </td>
    <td width="50%" style="vertical-align: top; padding: 10px; background-color: #0a0a2a; border-radius: 12px; color: #e0e0e0; border: 1px solid rgba(50, 150, 255, 0.2);">
      <h5>            </h5>
      <img 
        ...
        style="border-radius: 8px; margin-bottom: 10px;"
      >
      <h3 style="color: #00bfff;">Plantey: Autonomous Robot</h3>
      ...
      <a href="https://github.com/LovejeetM/autonomous_robot" target="_blank" style="color: #00bfff; text-decoration: none;">View Project →</a>
      <h5>            </h5>
    </td>
  </tr>
</table>
